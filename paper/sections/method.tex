...
For these methods, requirements are linked to the artifacts with similar vectors. 
 ...
 The following details the trace identification methods %Fig.~\ref{fig:trace-methods} summarizes these three methods to extract trace links.
...
\improvement{Fix caption of Figure 8: Information about software artifacts. The first bar chart shows the weekly issues (red) and pull requests (brown) created. The second barchart .... On the right, the total number of .... }
\begin{figure}[hbt]
    \centering
